...
[`skills` CLI](https://github.com/vercel-labs/skills) を使って、任意のAIコーディングエージェントにスキルをインストールできます。

### 全スキルをインストール

```bash
npx skills add derushio/wasm-skills
```
...
```bash
# MediaPipe系
npx skills add derushio/wasm-skills@mediapipe-wasm-setup
npx skills add derushio/wasm-skills@mediapipe-wasm-init
npx skills add derushio/wasm-skills@mediapipe-camera-input
npx skills add derushio/wasm-skills@mediapipe-hand-tracking
npx skills add derushio/wasm-skills@mediapipe-pose-estimation
npx skills add derushio/wasm-skills@mediapipe-face-mesh

# MuJoCo系
npx skills add derushio/wasm-skills@mujoco-wasm-setup
npx skills add derushio/wasm-skills@mujoco-wasm-init
npx skills add derushio/wasm-skills@mujoco-model-loading
npx skills add derushio/wasm-skills@mujoco-mjcf-reference
npx skills add derushio/wasm-skills@mujoco-simulation-loop
npx skills add derushio/wasm-skills@mujoco-threejs-integration

# 汎用WASM
npx skills add derushio/wasm-skills@wasm-nextjs-patterns
```
